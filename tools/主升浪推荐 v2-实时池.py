...
class MainWaveRecommenderV2:
    ...
    def recommend(self, top_n=3):
        """生成主升浪推荐"""
        # 获取实时观察池
        watch_list = self.fetch_realtime_watchlist()
        
        print(f"🔍 实时观察池：{len(watch_list)} 只股票")
...
def run_recommendation():
    """运行推荐"""
    recommender = MainWaveRecommenderV2()
